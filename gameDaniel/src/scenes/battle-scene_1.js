...
import { BattleScene } from './battle-scene.js';
  ...
  export class BATTLE_SCENE_1 extends Phaser.Scene {
    /**@type {BattleMenu} */
    #battleMenu
      ...
      this.#activePlayerMonster = new PlayerBattleMonster(
        {
          scene: this,
          monsterDetails: {
            name: MONSTER_ASSET_KEYS.WARRIOR,
            assetKey: MONSTER_ASSET_KEYS.WARRIOR,
            assetFrame: 0,
            currentHp: 30,
            maxHp: 30,
            attackIds: [2],
